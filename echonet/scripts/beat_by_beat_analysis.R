...
data <- read.csv(file.path(resultsDir, "echonet_video_r3d_18", "test_predictions.csv"), header = FALSE)
str(data)
...
sizeData <- read.csv(file.path(resultsDir, "echonet_segmentation_fcn_resnet50", "size.csv"))
